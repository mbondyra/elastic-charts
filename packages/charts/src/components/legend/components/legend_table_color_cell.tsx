...
import { LegendTableCell, LegendTableCellProps } from './legend_table_cell';
import { combineColors, highContrastColor } from '../../../common/color_calcs';
import { colorToRgba } from '../../../common/color_library_wrappers';
import { Color, Colors } from '../../../common/colors';

/** @public */
export type ColorStripCellProps = Omit<LegendTableCellProps, 'children' | 'width'> & {
  color?: string;
  displayOnly?: boolean;
};
 ...
 * @public
 */
export function LegendTableColorCell({
  color,
  className,
  displayOnly,
  ...cellProps
  ...
  const { backgroundColor, theme } = useLegendContext();
  ...
  const renderColorStrip = () => {
    ...
    return (
      <>
        <div className="echLegend__colorStrip--bg" style={{ backgroundColor }} />
        <div className="echLegend__colorStrip" style={{ backgroundColor: color }}>
          <div className="echLegend__colorStrip--icon" style={{ fill: dotColor }}>
        ...
        <div className="echLegend__colorStrip--spacer" />
      </>
    );
  };
  ...
  return (
    <LegendTableCell
      {...cellProps}
      className={classNames('echLegend__colorCell', className, {
        'echLegend__colorCell--static': displayOnly,
      })}
    >
      {renderColorStrip()}
    </LegendTableCell>
